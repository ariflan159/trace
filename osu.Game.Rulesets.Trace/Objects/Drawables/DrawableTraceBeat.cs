...
{
    public partial class DrawableTraceBeat : DrawableAngledTauHitObject<TraceBeat>
    {
        public Drawable DrawableBox;
        public DrawableTraceBeat()
            :this(null)
        {
        }
        public DrawableTraceBeat(TraceBeat obj) : base(obj)
        {
            
            Name = "Trace beat track";
            ...
            AddInternal(DrawableBox = new Container
            {
                ...
                Child = new ArcPiece(Color4.Yellow)
            });
